class FL_Strategy:
    ...
    def __init__(self, config_file):
        ...
        self.GLOBAL_TRAINING_ROUNDS = args[2]
        self.LEARNING_RATE = args[3]
        self.CRITERION = args[4]
        self.OPTIMIZER = args[5]
    ...
    def decode_args(self, args: list):
        ...
        """
        #str_args = {'optimizer': {'adam': optim.Adam, 'sgd': optim.SGD}, 'criterion': {'crossentropy': CrossEntropyLoss()}}
        num_args = ['min_clients_start', 'min_clients_fit', 'global_epochs']
...
class FL_Plan:
    ...
    """
    def __init__(self, fl_strategy_instance: FL_Strategy):
        self.GLOBAL_TRAINING_ROUNDS = fl_strategy_instance.GLOBAL_TRAINING_ROUNDS
        self.LEARNING_RATE = fl_strategy_instance.LEARNING_RATE
        self.CRITERION = fl_strategy_instance.CRITERION
        self.OPTIMIZER = fl_strategy_instance.OPTIMIZER
